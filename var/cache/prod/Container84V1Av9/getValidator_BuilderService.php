...
$instance->setConstraintValidatorFactory(new \Symfony\Component\Validator\ContainerConstraintValidatorFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(['MsgPhp\\User\\Infra\\Validator\\ExistingUsernameValidator' => function () {
    return ($this->privates['MsgPhp\\User\\Infra\\Validator\\ExistingUsernameValidator'] ?? $this->load('getExistingUsernameValidatorService.php'));
}, 'MsgPhp\\User\\Infra\\Validator\\UniqueUsernameValidator' => function () {
    return ($this->privates['MsgPhp\\User\\Infra\\Validator\\UniqueUsernameValidator'] ?? $this->load('getUniqueUsernameValidatorService.php'));
