...
// Returns the private 'App\Repository\ProjectRateRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProjectRateRepository.php';

return $this->privates['App\\Repository\\ProjectRateRepository'] = new \App\Repository\ProjectRateRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
