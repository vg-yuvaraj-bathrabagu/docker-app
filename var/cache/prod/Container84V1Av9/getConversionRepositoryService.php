...
// Returns the private 'App\Repository\ConversionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ConversionRepository.php';

return $this->privates['App\\Repository\\ConversionRepository'] = new \App\Repository\ConversionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
