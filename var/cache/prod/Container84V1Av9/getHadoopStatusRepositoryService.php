...
// Returns the private 'App\Repository\HadoopStatusRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/HadoopStatusRepository.php';

return $this->privates['App\\Repository\\HadoopStatusRepository'] = new \App\Repository\HadoopStatusRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
