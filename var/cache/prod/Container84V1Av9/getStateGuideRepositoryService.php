...
// Returns the private 'App\Repository\StateGuideRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/StateGuideRepository.php';

return $this->privates['App\\Repository\\StateGuideRepository'] = new \App\Repository\StateGuideRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
