...
// Returns the private 'App\Repository\MPPStatusRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MPPStatusRepository.php';

return $this->privates['App\\Repository\\MPPStatusRepository'] = new \App\Repository\MPPStatusRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
