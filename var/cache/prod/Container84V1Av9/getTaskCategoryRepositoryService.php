...
// Returns the private 'App\Repository\TaskCategoryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TaskCategoryRepository.php';

return $this->privates['App\\Repository\\TaskCategoryRepository'] = new \App\Repository\TaskCategoryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
