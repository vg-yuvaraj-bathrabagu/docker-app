...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(['MsgPhp\\User\\Infra\\Console\\Command\\AddUserRoleCommand' => function (): \MsgPhp\User\Infra\Console\Command\AddUserRoleCommand {
    return ($this->privates['MsgPhp\\User\\Infra\\Console\\Command\\AddUserRoleCommand'] ?? $this->load('getAddUserRoleCommandService.php'));
}, 'MsgPhp\\User\\Infra\\Console\\Command\\ChangeUserCredentialCommand' => function (): \MsgPhp\User\Infra\Console\Command\ChangeUserCredentialCommand {
    return ($this->privates['MsgPhp\\User\\Infra\\Console\\Command\\ChangeUserCredentialCommand'] ?? $this->load('getChangeUserCredentialCommandService.php'));
}, 'MsgPhp\\User\\Infra\\Console\\Command\\CreateUserCommand' => function (): \MsgPhp\User\Infra\Console\Command\CreateUserCommand {
    return ($this->privates['MsgPhp\\User\\Infra\\Console\\Command\\CreateUserCommand'] ?? $this->load('getCreateUserCommandService.php'));
}, 'MsgPhp\\User\\Infra\\Console\\Command\\DeleteUserCommand' => function (): \MsgPhp\User\Infra\Console\Command\DeleteUserCommand {
    return ($this->privates['MsgPhp\\User\\Infra\\Console\\Command\\DeleteUserCommand'] ?? $this->load('getDeleteUserCommandService.php'));
}, 'MsgPhp\\User\\Infra\\Console\\Command\\DeleteUserRoleCommand' => function (): \MsgPhp\User\Infra\Console\Command\DeleteUserRoleCommand {
    return ($this->privates['MsgPhp\\User\\Infra\\Console\\Command\\DeleteUserRoleCommand'] ?? $this->load('getDeleteUserRoleCommandService.php'));
...
}, 'liip_monitor.health_check.command' => function (): \Liip\MonitorBundle\Command\HealthCheckCommand {
    return ($this->services['liip_monitor.health_check.command'] ?? $this->load('getLiipMonitor_HealthCheck_CommandService.php'));
}, 'liip_monitor.list_checks.command' => function (): \Liip\MonitorBundle\Command\ListChecksCommand {
    return ($this->services['liip_monitor.list_checks.command'] ?? $this->load('getLiipMonitor_ListChecks_CommandService.php'));
