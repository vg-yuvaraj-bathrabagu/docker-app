...
// Returns the private 'App\Repository\SimulationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SimulationRepository.php';

return $this->privates['App\\Repository\\SimulationRepository'] = new \App\Repository\SimulationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
