...
// Returns the private 'App\Repository\TaskTemplateRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TaskTemplateRepository.php';

return $this->privates['App\\Repository\\TaskTemplateRepository'] = new \App\Repository\TaskTemplateRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
