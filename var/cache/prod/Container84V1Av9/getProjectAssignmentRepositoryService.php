...
// Returns the private 'App\Repository\ProjectAssignmentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProjectAssignmentRepository.php';

return $this->privates['App\\Repository\\ProjectAssignmentRepository'] = new \App\Repository\ProjectAssignmentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->privates['security.helper'] ?? $this->load('getSecurity_HelperService.php')));
