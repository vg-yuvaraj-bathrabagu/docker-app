...
// Returns the private 'App\Repository\FileWatcherRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FileWatcherRepository.php';

return $this->privates['App\\Repository\\FileWatcherRepository'] = new \App\Repository\FileWatcherRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
