...
// Returns the private 'App\Repository\EmployeeRelationshipRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EmployeeRelationshipRepository.php';

return $this->privates['App\\Repository\\EmployeeRelationshipRepository'] = new \App\Repository\EmployeeRelationshipRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
