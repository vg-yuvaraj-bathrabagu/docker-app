...
// Returns the private 'App\Repository\TaskQueueRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TaskQueueRepository.php';

return $this->privates['App\\Repository\\TaskQueueRepository'] = new \App\Repository\TaskQueueRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
