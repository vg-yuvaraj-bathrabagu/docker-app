...
// Returns the private 'App\Repository\CustomReportRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CustomReportRepository.php';

return $this->privates['App\\Repository\\CustomReportRepository'] = new \App\Repository\CustomReportRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->privates['security.helper'] ?? $this->load('getSecurity_HelperService.php')));
