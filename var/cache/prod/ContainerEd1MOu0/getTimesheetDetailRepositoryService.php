...
// Returns the private 'App\Repository\TimesheetDetailRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TimesheetDetailRepository.php';

return $this->privates['App\\Repository\\TimesheetDetailRepository'] = new \App\Repository\TimesheetDetailRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
