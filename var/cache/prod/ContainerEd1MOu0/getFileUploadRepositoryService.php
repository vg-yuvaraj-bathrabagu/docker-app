...
// Returns the private 'App\Repository\FileUploadRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FileUploadRepository.php';

return $this->privates['App\\Repository\\FileUploadRepository'] = new \App\Repository\FileUploadRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->privates['security.helper'] ?? $this->load('getSecurity_HelperService.php')));
