 ...
 * @ORM\Entity(repositoryClass="App\Repository\CustomReportRepository")
 */
class CustomReport extends Base
{
     ...
     * @var string
     *
     * @ORM\Column(name="athenaoutput", type="text", length=16777215, nullable=true)
     */
    protected $athenaoutput;
    /**
     * @var string
     *
    ...
    public function toArray() {
        return ['id' => $this->id,
                ...
                'athenaoutput' => $this->athenaoutput,
                'type' => $this->type
        ];
    }
