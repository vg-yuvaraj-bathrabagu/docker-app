...
INSERT INTO fileupload (\`name\`, \`folder\`, \`templateid\`, \`source\`, \`size\`, \`uuid\`,\`status\`, \`color\`, \`date\`, \`uploadedby\`, \`statusresult\`, \`accountid\`) VALUES ("$file_name", "$6", "$7", "$8", "$9", "${10}", "Pending", "orange", NOW(), ${11}, "Copy to Parquet completed", ${13});
EOF
echo 0
